...
const OurSolutions = () => {
  return (
    <section className='text-center  mt-12 px-4 md:px-0'>
      {/* Heading */}
      <h1 data-aos="fade-right" className='title-primary'>{solution.title}</h1>
      <p data-aos="fade-up"
     data-aos-duration="2000" className='text-primary text-lg max-w-2xl mx-auto mt-2'>
        {solution.subtitle}
      </p>
